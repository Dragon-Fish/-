mw.loader.using('jquery.cookie', function () {
  ...
  $('#shareQQ-btn').click(function () {
    //ZONE
    var zoneurl =
      'https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=https://wjghj.cn/index.php/' +
      config.wgPageName +
      '&sharesource=qzone&title=【' +
      config.wgPageName +
      '】-来自小鱼君和他的朋友们&summary=快来看看机智的小鱼君和他的朋友们的故事吧&pics=https://wjghj.cn/images/www/b/bc/Wiki.png'
    //FRIEND
    var friendurl =
      'http://connect.qq.com/widget/shareqq/index.html?url=https://wjghj.cn/index.php/' +
      config.wgPageName +
      '&sharesource=qzone&title=【' +
      config.wgPageName +
      '】-来自小鱼君和他的朋友们&summary=快来看看机智的小鱼君和他的朋友们的故事吧&pics=https://wjghj.cn/images/www/b/bc/Wiki.png'
    ssi_modal.show({
      ...
      content:
        ...
        '<div><a href="' +
        friendurl +
        '" target="_blank"><img src="/images/www/9/97/Qq_logo.png" style="height:50px;width:50px;border-radius:50%;border:1px solid gray;"></a></div>' +
        '<div><a href="' +
        zoneurl +
        '" target="_blank"><img style="height:50px;width:50px;border-radius:50%;border:1px solid orange;" src="/images/www/b/b8/Qzone_logo.png"></a></div>' +
        '<div><a href="' +
        friendurl +
        '" target="_blank">分享给好友</a></div>' +
        '<a href="' +
        zoneurl +
        '" target="_blank">分享到空间</a></div>' +
        '</div>',
      title: '分享到QQ',
    })
  })
  ...
  $('#QR-btn').click(function () {
    ...
    ssi_modal.show({
      ...
      content:
        '<center>' +
        QRimg +
        '<div>扫描或长按保存，然后分享给你的小伙伴吧！<br/><span style="color:gray;font-size:70%;">你也可以<a href="' +
        QRurl +
        '" target="_blank">直接下载</a>二维码</span></div>' +
        '</center>',
      title: '分享本页二维码',
    })
  })
