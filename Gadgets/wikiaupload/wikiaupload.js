  ...
  $('#wikiaupload #preview-btn').click(function() {
    if (FileName === '' || FileName === undefined) {
      ...
      .error(function(){
        ...
        $('#wikiaupload #preview-area #preview-filename').html('加载出错: ' + FileName + ' 可能不存在<img id="error-icon" src="/images/6/60/X_mark.png"/>').css({'color':'#b00','font-weight':'bold'});
      });
    }
  });
